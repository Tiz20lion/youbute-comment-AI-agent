...
{{
    ...
    "recommended_comment_style": "engaging"
            ...
            try:
                ...
                logger.warning(f"⚠️ Could not parse AI response as JSON for '{video_title}', using fallback")
                analysis_result = {
                    "content_summary": str(content_response)[:500] if content_response else "No analysis available",
