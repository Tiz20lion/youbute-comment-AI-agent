...
class YouTubeService:
    ...
    def get_oauth2_authorization_url(self) -> Optional[str]:
        """
    ...
    def complete_oauth2_authorization(self, authorization_response: str) -> bool:
        ...
        """
        try:
            if not hasattr(self, '_oauth_flow'):
                logger.error("OAuth2 flow not initialized")
                return False
    ...
    def is_authenticated_for_posting(self) -> bool:
        ...
        try:
            ...
            if not self.youtube_oauth:
                return self._initialize_oauth_service()
