...
<img src="https://raw.githubusercontent.com/Tiz20lion/youbute-comment-AI-agent/master/file_00000000c8c46243b2a8cd8d82e35807.png" alt="Tiz Lion AI Logo" width="150">
...
[![Docker Image Size](https://img.shields.io/docker/image-size/tiz20lion/youbute-comment-ai-agent/latest)](https://hub.docker.com/r/tiz20lion/youbute-comment-ai-agent)

[📂 **GitHub Repository**](https://github.com/Tiz20lion/youbute-comment-AI-agent) | [🎥 **Watch Demo**](https://www.loom.com/share/ebc1e5a6011f440f838176c306b381f9?sid=3b81e1e4-0585-4dc6-9f30-25014948885e)
...
### Pull the Image
```bash
docker pull tiz20lion/youbute-comment-ai-agent:latest
```
...
```bash
docker run -d -p 8080:8080 --env-file .env --name youtube-ai tiz20lion/youbute-comment-ai-agent
```
...
### Ports
- **8080**: FastAPI web server (internal port)
...
docker run -d \
  ...
  --env-file .env \
  -v $(pwd)/data:/app/data \
  tiz20lion/youbute-comment-ai-agent:latest
```
...
- **📚 Full Documentation**: [GitHub Repository](https://github.com/Tiz20lion/youbute-comment-AI-agent)
...
- **🐛 Issues & Support**: [GitHub Issues](https://github.com/Tiz20lion/youbute-comment-AI-agent/issues)
